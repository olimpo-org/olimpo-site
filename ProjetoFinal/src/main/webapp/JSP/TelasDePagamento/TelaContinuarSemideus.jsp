...
<div class="plano">
    <img src="../../Imagens/ImagensPagamento/PlanoSemideus.png" alt="">
    <p>Plano de propaganda - SEMIDEUS</p>
    <h2>R$<%=String.format("%.2f",planoDAO.mostrarPlanos(1))%></h2>
</div>
<div class="descricao">
    <h1>Descrição</h1>
    <p>Plano de propaganda que te garante a criação de uma propaganda de baixo alcance dentro do Olimpo.</p>
</div>
<h2>Selecione sua forma de pagamento: </h2>
<div class="formasPagamento">
    <a href="../../HTML/Pagamentos/cartaoCredito.html" class="forma">
