...
<div class="plano">
    <img src="../../Imagens/ImagensPagamento/PlanoTita.png" alt="">
    <p>Plano de propaganda - TITÃ</p>
    <h2>R$<%=String.format("%.2f",planoDAO.mostrarPlanos(3))%></h2>
</div>
<div class="descricao">
    <h1>Descrição</h1>
    <p>Plano de propaganda que te garante a criação de uma propaganda de alto alcance dentro do Olimpo.</p>
</div>
